...
public class DrawingSurface extends JPanel implements KeyListener, Runnable {
    ...
    public void moveBall() {
        ...
        for (int i = 0; i < theBalls.size(); i++) {
            ...
            */
            theBalls.get(i).setySpeed(theBalls.get(i).getySpeed()+0);
            ...
            if (theBalls.get(i).getY() + theBalls.get(i).getRadius() > 800 && theBalls.get(i).getY() < 1000) {
                if (theBalls.get(i).getX() + theBalls.get(i).getRadius() > 800 && theBalls.get(i).getX() < 1000) {
                    ...
                    //Top
                    if (theBalls.get(i).getX() + theBalls.get(i).getRadius() > 800 && theBalls.get(i).getX() < 1000) {
                        if (theBalls.get(i).getY() + theBalls.get(i).getRadius() > 800 && theBalls.get(i).getY() < 820) {
                            theBalls.get(i).setySpeed(theBalls.get(i).getySpeed() * -1);
                        }
                    }
                    //Left
                    if (theBalls.get(i).getX() + theBalls.get(i).getRadius() > 800 && theBalls.get(i).getX() < 820) {
                        if (theBalls.get(i).getY() + theBalls.get(i).getRadius() > 800 && theBalls.get(i).getY() < 1000) {
                            theBalls.get(i).setxSpeed(theBalls.get(i).getxSpeed() * -1);
                        }
                    }
                    ...
                    //Right
                    if (theBalls.get(i).getX() + theBalls.get(i).getRadius() > 980 && theBalls.get(i).getX() < 1000) {
                        if (theBalls.get(i).getY() + theBalls.get(i).getRadius() > 800 && theBalls.get(i).getY() < 1000) {
                            theBalls.get(i).setxSpeed(theBalls.get(i).getxSpeed() * -1);
                        }
                    }
                    ...
                    //Bottom
                    if (theBalls.get(i).getX() + theBalls.get(i).getRadius() > 800 && theBalls.get(i).getX() < 1000) {
                        if (theBalls.get(i).getY() + theBalls.get(i).getRadius() > 980 && theBalls.get(i).getY() < 1000) {
                            theBalls.get(i).setySpeed(theBalls.get(i).getySpeed() * -1);
                        }
                    }
    ...
    public void wPress() {
        int i = 0;
        theBalls.get(i).setySpeed(-3);
    }

    public void aPress() {
        int i = 0;
        theBalls.get(i).setxSpeed(-3);
