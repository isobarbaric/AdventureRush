...
public final class LoginPortalPrimaryWindow extends javax.swing.JFrame {
    ...
    public void loadRegisteredUsers() {
        ...
        while (scanner.hasNextLine()) {
            ...
            //If the next line equals 0
            if (Integer.parseInt(scanner.nextLine()) == 0) {
                
                sprite1 = false; //The user doesn't have the sprite
                
            } else {
                
                sprite1 = true; //The user has the sprite
            ...
            if (Integer.parseInt(scanner.nextLine()) == 0) {
                ...
                sprite2 = false; //The user doesn't have the sprite
                
            } else {
                
                sprite2 = true; //The user has the sprite
            ...
            if (Integer.parseInt(scanner.nextLine()) == 0) {
                ...
                sprite3 = false; //The user doesn't have the sprite
                
            } else {
                
                sprite3 = true; //The user has the sprite
                
            }
            
            
            User currentUser = new User(username, password, lastLevel, currencyPossessed, sprite1, sprite2, sprite3);
